...
public class GLRootView extends GLSurfaceView
    ...
    public void setLightsOutMode(boolean enabled) {
        if (!ApiHelper.HAS_SET_SYSTEM_UI_VISIBILITY || mDisableLightOutMode) return;
    ...
    private void onDrawFrameLocked(GL10 gl) {
        ...
        if (mContentView != null) {
            ...
            //*/ Modified by droi Linguanrong for freeme gallery, 16-4-1
            if(mDefaultBackgroundColor != null) {
                mCanvas.clearBuffer(mDefaultBackgroundColor);
            } else {
                mCanvas.clearBuffer();
            }
            //*/
    ...
    private float[] mDefaultBackgroundColor;
    ...
    private boolean mDisableLightOutMode = false;
    public void setLigthOutMOdeDisable(boolean disable) {
        mDisableLightOutMode = disable;
    }
}
